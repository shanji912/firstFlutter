...
import 'package:my_flutter/db/provider/user/user_followed_db_provider.dart';
import 'package:my_flutter/db/provider/user/user_follower_db_provider.dart';
import 'package:my_flutter/db/provider/user/userinfo_db_provider.dart';
import 'package:my_flutter/db/provider/user/user_orgs_db_provider.dart';
import 'package:my_flutter/common/config/config.dart';
import 'package:my_flutter/common/config/ignoreConfig.dart';
import 'package:my_flutter/common/dao/dao_result.dart';
import 'package:my_flutter/common/local/local_storage.dart';
import 'package:my_flutter/model/Notification.dart' as model;
import 'package:my_flutter/model/SearchUserQL.dart';
import 'package:my_flutter/model/User.dart';
import 'package:my_flutter/model/UserOrg.dart';
...
import 'package:my_flutter/redux/user_redux.dart';
...
class UserDao {
  ...
  ///初始化用户信息
  static initUserInfo(Store<SaintState> store) async {
