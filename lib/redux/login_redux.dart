...
import 'package:my_flutter/db/sql_manager.dart';
import 'package:my_flutter/common/dao/user_dao.dart';
import 'package:my_flutter/redux/saint_state.dart';
import 'package:my_flutter/common/utils/common_utils.dart';
import 'package:my_flutter/common/utils/navigator_utils.dart';
...
class LoginMiddleware implements MiddlewareClass<SaintState> {
  @override
  void call(Store<SaintState> store, dynamic action, NextDispatcher next) {
...
Stream<dynamic> loginEpic(Stream<dynamic> actions, EpicStore<SaintState> store) {
  Stream<dynamic> _loginIn(
      LoginAction action, EpicStore<SaintState> store) async* {
...
Stream<dynamic> oauthEpic(Stream<dynamic> actions, EpicStore<SaintState> store) {
  Stream<dynamic> _loginIn(
      OAuthAction action, EpicStore<SaintState> store) async* {
    CommonUtils.showLoadingDialog(action.context);
