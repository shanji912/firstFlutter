...
import 'package:my_flutter/widget/saint_card_item.dart';
import 'package:my_flutter/widget/gsy_input_widget.dart';
  ...
  renderTitleInput() {
    return (widget.needTitle)
        ? Padding(
            ...
            child: SaintInputWidget(
              onChanged: widget.onTitleChanged,
              controller: widget.titleController,
              hintText:
                  SaintLocalizations.i18n(context)!.issue_edit_issue_title_tip,
              obscureText: false,
            ))
        : Container();
  }
                                ...
                                Expanded(
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText: SaintLocalizations.i18n
                                        (context)!
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                  child: RawMaterialButton(
                                      ...
                                      child: Text(
                                          SaintLocalizations.i18n(context)!
                                              .app_cancel,
                              ...
                              Expanded(
                                  child: RawMaterialButton(
                                      ...
                                      constraints: const BoxConstraints(
                                          minWidth: 0.0, minHeight: 0.0),
                                      child: Text(
                                          SaintLocalizations.i18n(context)!.app_ok,
                                          style: GSYConstant.normalTextBold),
...
var FAST_INPUT_LIST = [
  FastInputIconModel(SaintICons.ISSUE_EDIT_H1, "\n# "),
  FastInputIconModel(SaintICons.ISSUE_EDIT_H2, "\n## "),
  FastInputIconModel(SaintICons.ISSUE_EDIT_H3, "\n### "),
  FastInputIconModel(SaintICons.ISSUE_EDIT_BOLD, "****"),
  FastInputIconModel(SaintICons.ISSUE_EDIT_ITALIC, "__"),
  FastInputIconModel(SaintICons.ISSUE_EDIT_QUOTE, "` `"),
  FastInputIconModel(SaintICons.ISSUE_EDIT_CODE, " \n``` \n\n``` \n"),
  FastInputIconModel(SaintICons.ISSUE_EDIT_LINK, "[](url)"),
];
